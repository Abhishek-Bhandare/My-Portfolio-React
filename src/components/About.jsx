      ...
      <div className="flex flex-col px-10 items-center gap-20 lg:flex-row ">
        ...
        <div className="max-w-lg text-center lg:text-justify">
          ...
          <h1 className="font-bold text-xl   my-5">
            A dedicated Front-end Developer based in Pune,MH,India 📍
          </h1>
          <p className="text-gray-500 text-lg">
            As a Front-End React Developer with 2.5 years of Experience, I possess an impressive arsenal of
            skills in HTML, CSS, JavaScript & ES6, React, Redux, Tailwind CSS, Bootstrap, Java. I excel
